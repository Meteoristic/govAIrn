...
console.log('\nIMPORTANT: Vite applications do not always directly use');
console.log('Node.js environment variables. They require the "VITE_" prefix');
console.log('and are handled differently during build/runtime.');
console.log('\nFor OpenAI API key in the browser, try using:');
console.log('localStorage.setItem("OPENAI_API_KEY", "your-key-here");');
console.log('to test if that makes a difference in the UI.\n'); 